...
class EditDietPage extends StatefulWidget {
  ...
  const EditDietPage({Key? key, required this.data}) : super(key: key);
...
class _EditDietPageState extends State<EditDietPage> {
  ...
  createNewDiet() {
    try {
      clientRepository.updateDietItem(
      ...
      showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text("A new diet has been updated",
                  style: GoogleFonts.lato(
                    fontSize: 24,
